...
_SNAPSHOT_EXCLUDED_ENV_REGEX = (
    ...
    "HERMES_CRON_SESSION|HERMES_RUN_ID|HERMES_BROWSER_CONTROL_|HERMES_DELEGATED_CHILD_CONTEXT)")
...
def _export_dump_excluding_session_vars(tmp_path: str, excluded_names: Iterable[str] = ()) -> str:
    ...
    return (
        ...
        "HERMES_DELEGATED_CHILD_CONTEXT HERMES_CRON_SESSION HERMES_RUN_ID "
